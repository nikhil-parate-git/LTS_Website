...
const TopRatedBusinesses = lazy(() => import("../topratedbusiness/TopRatedBusinesses"));
const TopCategoryCity = lazy(() => import("../topcategorycity/TopCategoryCity"));
...
function HeroSlider() {
  ...
  useEffect(() => { bannerLenRef.current = banners?.length ?? 0; }, [banners]);
