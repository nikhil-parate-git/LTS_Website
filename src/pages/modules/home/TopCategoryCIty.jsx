...
const categories = [
  ...
  { id: 2,  slug: "business-office",           name: "Business Needs & Office Supplies", Icon: Briefcase },
  { id: 3,  slug: "repairs-service",           name: "Repairs & Service",               Icon: Wrench },
  { id: 4,  slug: "brokers-agents",            name: "Brokers, Agents & Agencies",      Icon: Users },
  { id: 5,  slug: "consultants",               name: "Consultants & Professionals",     Icon: UserCircle },
  { id: 6,  slug: "advertising-marketing",     name: "Advertising & Marketing",         Icon: Megaphone },
  { id: 7,  slug: "doctors-hospitals",         name: "Doctors, Clinics & Hospitals",    Icon: Stethoscope },
  { id: 8,  slug: "kids-children",             name: "Kids & Children",                 Icon: Baby },
  { id: 9,  slug: "fun-entertainment",         name: "Fun & Entertainment",             Icon: Ticket },
  { id: 10, slug: "party-events-weddings",     name: "Party, Events & Weddings",        Icon: PartyPopper },
  { id: 11, slug: "restaurants-food",          name: "Restaurants, Food & Drinks",      Icon: UtensilsCrossed },
  { id: 12, slug: "salon-beauty-spa",          name: "Salon, Beauty & Spa",             Icon: Scissors },
  { id: 13, slug: "contractors",               name: "Contractors",                     Icon: HardHat },
  { id: 14, slug: "furniture",                 name: "Furniture",                       Icon: Sofa },
  { id: 15, slug: "electricals-lights",        name: "Electricals & Lights",            Icon: Lightbulb },
  { id: 16, slug: "flooring-walls-roofing",    name: "Flooring, Walls & Roofing",       Icon: Layers },
  { id: 17, slug: "architecture-interiors",    name: "Architecture & Interiors",        Icon: Ruler },
  { id: 18, slug: "plywood-hardware-paint",    name: "Plywood, Hardware & Paint",       Icon: Hammer },
  { id: 19, slug: "sanitary-bath",             name: "Sanitary & Bath Fittings",        Icon: Bath },
  { id: 20, slug: "travel-tourism",            name: "Travel & Tourism",                Icon: Plane },
  { id: 21, slug: "hotels-accommodation",      name: "Hotels & Accommodation",          Icon: Hotel },
  { id: 22, slug: "hobby-classes",             name: "Hobby Classes",                   Icon: Palette },
  { id: 23, slug: "education-coaching",        name: "Education, Coaching & Training",  Icon: GraduationCap },
  { id: 24, slug: "gifting",                   name: "Gifting",                         Icon: Gift },
  { id: 25, slug: "health-fitness-sports",     name: "Health, Fitness & Sports",        Icon: Dumbbell },
  { id: 26, slug: "home-kitchen",              name: "Home & Kitchen",                  Icon: ChefHat },
  { id: 27, slug: "clothing-fashion",          name: "Clothing & Fashion",              Icon: ShoppingBag },
  { id: 28, slug: "jewellery",                 name: "Jewellery",                       Icon: Gem },
  { id: 29, slug: "cars-bikes-automobiles",    name: "Cars, Bikes & Automobiles",       Icon: Car },
  { id: 30, slug: "courier-transport",         name: "Courier, Transport & Logistics",  Icon: Truck },
  { id: 31, slug: "real-estate",               name: "Real Estate",                     Icon: Building2 },
  { id: 32, slug: "financial-services",        name: "Financial Services",              Icon: Landmark },
  { id: 33, slug: "it-services",               name: "IT Services",                     Icon: Monitor },
  { id: 34, slug: "laptops-mobiles",           name: "Laptops, Mobiles & Computers",    Icon: Smartphone },
  { id: 35, slug: "electronics-appliances",    name: "Electronics & Appliances",        Icon: Tv },
  { id: 36, slug: "printing-display-signage",  name: "Printing, Display & Signage",     Icon: Printer },
  { id: 37, slug: "security-surveillance",     name: "Security & Surveillance",         Icon: Camera },
  { id: 38, slug: "machines-tools",            name: "Machines, Tools & Equipments",    Icon: Settings2 },
  { id: 39, slug: "farming-plants-pets",       name: "Farming, Plants, Flowers & Pets", Icon: Leaf },
];

const INITIAL_SHOW = 23; // 23 cats + 1 ViewMore = 24 slots (8×3 desktop)
    ...
    >
      <div
        ...
        style={{
          ...
          background: hovered ? "linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%)" : "#fff",
      ...
      >
        <Icon
          className="cat-icon"
          strokeWidth={1.6}
          style={{ color: hovered ? "#f97316" : "#6b7280", transition: "color 0.2s ease" }}
        />
      </div>
      <p
