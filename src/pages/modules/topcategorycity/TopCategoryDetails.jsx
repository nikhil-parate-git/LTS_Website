...
//                       <div className="w-1.5 h-1.5 rounded-full bg-gray-300 group-hover:bg-orange-400 transition-colors"></div>
//                       <div className="w-1.5 h-1.5 rounded-full bg-gray-300 group-hover:bg-orange-400 transition-colors delay-75"></div>
//                       <div className="w-1.5 h-1.5 rounded-full bg-gray-300 group-hover:bg-orange-400 transition-colors delay-150"></div>
//                     </div>
//                   </div>
...
//                     </p>
//                   </div>
//                   <ul className="space-y-2 max-h-64 overflow-y-auto" style={{ scrollbarWidth: 'thin', scrollbarColor: '#e5e7eb #f3f4f6' }}>
...
//                           {item}
//                         </span>
//                         <ArrowRight size={12} className="opacity-0 group-hover/item:opacity-100 transition-all duration-200 transform group-hover/item:translate-x-0 -translate-x-2" />
//                       </li>
//                     ))}
//                   </ul>
//                 </div>
      ...
      <div className="w-full px-3 sm:px-6 md:px-8 py-6 sm:py-8">
        {filteredSections.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200 shadow-inner">
             ...
             <p className="text-gray-500 font-medium text-lg">No subcategories found matching your search.</p>
          </div>
        )}
      </div>
      <style jsx>{`
