...
// // ─── ReviewCard — with inline edit & delete ───────────────────────────────────
// function ReviewCard({ review, currentCustomerId }) {
//   const dispatch = useDispatch();
//   const { updating, deleting } = useSelector((state) => state.vendorReviews);

//   const reviewId = review?.reviewId;
//   const customerId = review?.customerId?._id;
//   const isOwner = currentCustomerId && customerId === currentCustomerId;
...
//   // Current logged-in customer id — stored in localStorage after login
...
//   // ── Re-fetch after new review submitted ───────────────────────────────────
//   useEffect(() => {
...
export default function Details() {
  ...
  // ── Send Enquiry — same logic as BusinessCard in CategoryDetails ──────────
    ...
    <div className="min-h-screen bg-gray-50 font-sans pb-20">
      ...
      <div className="w-full mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-5 mb-5 border border-gray-100">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            {/* ── Send Enquiry button — now uses handleSendEnquiry ── */}
            <button
