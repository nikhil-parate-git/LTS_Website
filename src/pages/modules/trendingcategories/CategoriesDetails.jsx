...
const BusinessCard = memo(function BusinessCard({ biz }) {
  ...
  const handleSendEnquiry = useCallback(() => {
    const meta = {
      venId: biz.mongoId, // MongoDB _id — "69e23..."
      catId: biz.catId, // "CAT-010" — backend fix ke baad string bhi chalti hai
      subCateId: biz.subCateId, // "SUBCAT-153"
    };
    sessionStorage.setItem("enquiryMeta", JSON.stringify(meta));
    navigate(`/submitenquiry/${biz.catId}/${biz.subCateId}`, { state: meta });
  }, [biz.mongoId, biz.catId, biz.subCateId, navigate]);
        ...
        <div className="flex-1 p-4 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between gap-2 mt-1 flex-wrap">
            <button
              ...
              className="flex items-center cursor-pointer justify-center gap-2 min-w-[140px] px-4 py-3 rounded-lg text-xs font-bold bg-orange-500 text-white hover:bg-orange-600 transition-all duration-300"
            >
              <Phone size={13} />
                  ...
                  {vendors.map((biz) => (
                    <BusinessCard
                      ...
                      biz={{
                        ...
                        mongoId: biz.venId,
                        catId: catId, // "CAT-010"
                        subCateId: subCateId, // "SUBCAT-153"
                      }}
                    />
                  ))}
                </div>
