...
export default function PrimeCard({ plan, stepNum, onPurchase }) {
  ...
  return (
    <div className="relative flex flex-col bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl h-full">
      ...
      <div className="p-7 pt-10 flex flex-col flex-1">
        ...
        <button
          ...
          className="w-full cursor-pointer py-3.5 rounded-xl text-[13px] font-extrabold tracking-widest uppercase bg-blue-500 text-white hover:bg-blue-600 transition-all duration-200 shadow-lg shadow-blue-500/20"
        >
          Get Started →
        </button>
      </div>
