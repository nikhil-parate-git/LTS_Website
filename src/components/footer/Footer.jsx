...
//               Local Trade Street is a modern digital platform designed to
//               connect local businesses, traders, and customers in one unified
//               marketplace. Our goal is to empower small and medium enterprises
//               by providing them with a powerful online presence and easy access
//               to potential buyers.
//             </p>
//           </div>
...
//           <p className="text-white text-[12px] flex items-center justify-center gap-1 flex-wrap whitespace-nowrap">
//             <span>Design And Developed By</span>
//             <a
//               href="https://www.talentrisetechnokrate.com/"
//               target="_blank"
//               rel="noopener noreferrer"
//               className="inline-flex items-center justify-center rounded-md  text-white  hover:shadow-lg transition-all duration-200 font-medium hover:underline"
//             >
...
export default function Footer() {
  return (
    <footer className="w-full bg-[#1a2332] text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-14">
          ...
          <div className="flex flex-col items-center sm:items-start space-y-5">
            ...
            <p className="text-gray-300 text-sm leading-relaxed text-center sm:text-left">
              Local Trade Street is a modern digital platform designed to
              connect local businesses, traders, and customers in one unified
              marketplace. Empowering SMEs with powerful online presence.
            </p>
          </div>

          {/* COL 2 — Explore (SEO Friendly) */}
          <div className="flex flex-col items-center sm:items-start">
            <h4 className="font-bold text-xs uppercase tracking-widest mb-6 pb-2 border-b-2 border-orange-500 w-full text-center sm:text-left">
              Explore
            </h4>
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <ul className="flex flex-col gap-5">
              <li className="flex items-center gap-4 group">
                <div className="w-10 h-10 rounded-full bg-[#243650] flex items-center justify-center shrink-0 group-hover:bg-orange-500 transition-all">
              ...
              <li className="flex items-start gap-4 group">
                <div className="w-10 h-10 rounded-full bg-[#243650] flex items-center justify-center shrink-0 mt-1 group-hover:bg-orange-500 transition-all">
          ...
          {/* COL 4 — Follow Us (Fixed Social Links) */}
          <div className="flex flex-col items-center sm:items-start">
            <h4 className="font-bold text-xs uppercase tracking-widest mb-6 pb-2 border-b-2 border-orange-500 w-full text-center sm:text-left">
              Follow Us
            </h4>
            <div className="grid grid-cols-4 gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[#1877f2] flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
                style={{
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-black flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-red-600 flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[#E60023] flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[#25d366] flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
                <WhatsAppIcon size={20} />
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-[#0a66c2] flex items-center justify-center hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 pointer-events-auto"
              >
      ...
      {/* ── BOTTOM BAR ── */}
      <div className="border-t border-white/10 py-6 bg-[#151c29]">
        <div className="w-full px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-gray-400 tracking-wider uppercase text-center md:text-left">
          <p>© 2026 Local Trade Street. All Rights Reserved.</p>
